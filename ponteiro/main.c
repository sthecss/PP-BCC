 ...
 * cálculos algébricos básicos, tendo como foco a manipulacao
 * de ponteiros. O usuário pode escolher uma opção do menu
 * para executar a funcionalidade desejada.
 *
